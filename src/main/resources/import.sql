...
#INSERT INTO ebooks (title, author, keywords, publication_year, document_name, filename, mime, language_id, category_id, user_id) VALUES ('Koridor 10 do kraja 2010', 'Miki - copy sa B92', 'koridor, autoput', 2009, 'Koridor 10 do kraja 2010.pdf', '1547586650590-Koridor 10 do kraja 2010.pdf', null, 2, 1, 1);
#INSERT INTO ebooks (title, author, keywords, publication_year, document_name, filename, mime, language_id, category_id, user_id) VALUES ('Otvorene dve deonicekoridora 10', 'Miki123', 'autoput, koridor', 2009, 'Otvorene dve deonicekoridora 10.pdf', '1547586670982-Otvorene dve deonicekoridora 10.pdf', null, 2, 1, 1);
#INSERT INTO ebooks (title, author, keywords, publication_year, document_name, filename, mime, language_id, category_id, user_id) VALUES ('Pandemija gripa?', 'Miki321', 'sumnja, pandemija, gripa', 2009, 'Pandemija gripa.pdf', '1547586678320-Pandemija gripa.pdf', null, 2, 1, 1);
